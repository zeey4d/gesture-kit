"use strict";
/**
 * PinchGesture — A component that detects pinch-to-zoom gestures.
 *
 * @example
 * ```tsx
 * <PinchGesture onPinch={(e) => console.log('Scale:', e.scale)}>
 *   <Image source={src} />
 * </PinchGesture>
 * ```
 */
...
/** Map RNGH Pinch event to our PinchEvent */
...
const PinchGesture = ({ children, onPinchStart, onPinch, onPinchEnd, enabled = true, }) => {
