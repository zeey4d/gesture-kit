"use strict";
/**
 * FlingGesture — A component that detects quick fling gestures.
 *
 * @example
 * ```tsx
 * <FlingGesture direction="up" onFling={(e) => console.log('Flung up!')}>
...
/** Map direction string to RNGH Directions flags */
...
const FlingGesture = ({ children, onFling, direction, numberOfPointers = 1, enabled = true, }) => {
...
exports.FlingGesture.displayName = 'FlingGesture';
